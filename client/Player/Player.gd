...
const PlayerStatsScene = preload("res://UI/PlayerStats.tscn")
...
func _physics_process(delta):
	if Input.is_action_pressed("toggle_player_stats"):
		var playerStatsInstance = PlayerStatsScene.instance()
		get_tree().root.add_child(playerStatsInstance)
	match state:
		MOVE:
			move_state(delta)
